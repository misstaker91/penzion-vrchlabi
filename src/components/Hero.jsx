      ...
      content: (
        <div className="content-section">
          <div className="content-wrapper">
            ...
            <h2 className="rooms-title">Ceník 2027 - dle požadavků Svatebčanů</h2>
            <ul className="rooms-list">
              <li className="room-item">Příprava obřadního prostoru: 2.000 Kč</li>
              <li className="room-item">Pronájem mlat + bar: 14.000 Kč</li>
              <li className="room-item">Pronájem párty stanu / akce: 12.000 Kč</li>
              <li className="room-item">Gril (rožeň): 2.000 Kč</li>
              <li className="room-item">Gril (rožeň + 10 kg kýta): 8.000 Kč</li>
              <li className="room-item">Ubytování osoba / noc: 700 Kč</li>
              <li className="room-item">Ubytování při uzavření penzionu min. sazba za noc: 11.200 Kč</li>
              <li className="room-item">Nad 16 osob každá další osoba / noc: 700 Kč</li>
            </ul>
          </div>
        </div>
      )
